...
// or
val getAge1 = { person:c05.Person1 -> person.age }
...
fun constRef() {
    ...
    fun c05.Person1.isAdult() = age > 21 // you can also reference extension functions the same way
    val predicate = c05.Person1::isAdult
}
...
val p = c05.Person1("tom", 34)

val personAgeFunction = c05.Person1::age
fun printPAge() {
